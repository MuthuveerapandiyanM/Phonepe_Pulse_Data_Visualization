...
path = "C:/Users/ELCOT/Desktop/PYTHON/pulse/data/aggregated/transaction/country/india/state/"
Agg_state_list = os.listdir(path)

#print(Agg_state_list) this for check above code is working or not
...
path2 = "C:/Users/ELCOT/Desktop/PYTHON/pulse/data/aggregated/user/country/india/state/"
...
path3 = "C:/Users/ELCOT/Desktop/PYTHON/pulse/data/map/transaction/hover/country/india/state/"
...
path4 = "C:/Users/ELCOT/Desktop/PYTHON/pulse/data/map/user/hover/country/india/state/"
...
path5 = "C:/Users/ELCOT/Desktop/PYTHON/pulse/data/top/transaction/country/india/state/"
...
path6 = "C:/Users/ELCOT/Desktop/PYTHON/pulse/data/top/user/country/india/state/"
...
st.title(':black[Phonepe Pulse Data Visualization and Exploration]')
SELECT = option_menu(
    menu_title=None,
    options=["About", "Search", "Home", "Basic insights"],
    icons=["bar-chart", "search", "house", "toggles"],
    default_index=2,
...
if SELECT == "Home":
    st.subheader('Phonepe Pulse Data Visualization')
    st.caption(
        "PhonePe  is an Indian Digital Payments and Financial Technology Company.From Phonepe we have to develop a user-friendly and interactive web application for visualizing and exploring data related to the Phonepe Pulse digital payments platform in India. The tool will allow users to gain insights into transaction volumes, user demographics, and other key metrics related to the usage of the platform.")


if SELECT == "Basic insights":
    st.title("BASIC INSIGHTS")
    st.caption('Process of extracting valuable information from data, which can help in making informed decisions or taking actions')
...
if SELECT == "About":
    ...
    st.caption("Phonepe allows users to make payments, transfer money, and perform other financial transactions using their smartphones. It offers a wide range of services, including bill payments, mobile recharges, and online shopping payments, among others.The Phonepe Pulse Data Visualization and Exploration tool will be designed to allow users to select from a variety of pre-built visualizations or create their own custom visualizations using the available data. Users will be able to filter and aggregate data by various dimensions such as time, transaction type, and user location.")
    st.caption('Technologies are :blue[Github Cloning, Python, Pandas, SQLite3,Streamlit, and Plotly].')
